...
/* v2 supercall layout (ReSukiSU ksud): char pathname[]; int err */
...
/* v2 supercall layout (mirror ReSukiSU ksud SusfsSusKstat) */
...
/* v2 supercall layout (mirror ReSukiSU ksud SusfsUname) */
...
/* v2 supercall layout (mirror ReSukiSU ksud SusfsOpenRedirect) */
...
int susfs_sus_su(void __user **arg);
#endif
/* susfs_init */
